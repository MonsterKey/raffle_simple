...
describe("raffle_simple", () => {
  ...
  //   )
  //   // Add your test here.
  //   await program.methods.updateRaffle(new anchor.BN(1662455998), new anchor.BN(100), new anchor.BN(100), new anchor.BN(0)).accounts({
  //     raffle: rafflePDA,
  ...
  it("Burn token", async () => {
    ...
    await program.methods.burnToken(new anchor.BN(100)).accounts({
      raffle: rafflePDA,
